...
console.log(`GitHub Repository: henryvn27/meetily_improved`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/henryvn27/meetily_improved/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/henryvn27/meetily_improved/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/henryvn27/meetily_improved/releases/latest/download/latest.json`);
