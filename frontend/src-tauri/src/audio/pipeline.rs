...
impl AudioPipeline {
    #[allow(clippy::too_many_arguments)] // Device metadata stays explicit at pipeline construction.
    pub fn new(
        receiver: mpsc::UnboundedReceiver<AudioChunk>,
        transcription_sender: mpsc::UnboundedSender<AudioChunk>,
...
impl AudioPipelineManager {
    ...
    #[allow(clippy::too_many_arguments)] // Device metadata stays explicit at pipeline startup.
    pub fn start(
        &mut self,
        state: Arc<RecordingState>,
        transcription_sender: mpsc::UnboundedSender<AudioChunk>,
